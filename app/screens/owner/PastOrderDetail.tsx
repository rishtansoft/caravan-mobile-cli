        ...
        <View style={styles.container_all}>
            <View style={styles.header_con}>
                ...
                </View>
                {
                    locations && locations.length > 0 && <IconFoundation
                        onPress={() => navigation.navigate('history_detail_map', { itemId: itemId, data: locations, status: result?.status })}
            ...
            </View>
            {
                result && <ScrollView style={{ flex: 1, paddingBottom: 10 }}>
                    ...
                    {
                        locations && locations.length > 0 && <TouchableOpacity onPress={() => navigation.navigate('history_detail_map', { itemId: itemId, data: locations, status: result?.status })}
