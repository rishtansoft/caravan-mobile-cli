        ...
        <View style={styles.container_all}>
            <View style={styles.header_con}>
                ...
                <MaterialCommunityIcons
                    // onPress={() => navigation.navigate('home')}
                    name="arrow-collapse-down" size={25} color="#7257FF" />
            </View>
            <View style={styles.container}>
                <Text style={{ color: '#7257FF', }}>DESIGN SYSTEM</Text>
                <Text style={{ color: '#131214', fontSize: 24, fontWeight: '600', marginVertical: 14 }}>White-labeling: Putting the design system in users' hands</Text>
            </View>
            ...
            <FlatList
                ...
                renderItem={({ item }) => (
                    <View style={styles.container}>
                        <Text style={{ color: '#131214', fontSize: 16, fontWeight: '500', marginBottom: 10 }} >{item.title}</Text>
                        <Text style={{ color: '#131214', fontSize: 16, marginBottom: 10 }}>{item.text_1}</Text>
                        <Text style={{ color: '#131214', fontSize: 16, marginBottom: 10 }}>{item.text_2}</Text>
                    </View>
                )}
