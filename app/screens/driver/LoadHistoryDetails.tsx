...
const defaultData = {
  ...
  cargo_details: {
    ...
    stopover_address:
      "Namangan viloyati, Chust tumani, Cho'pon MFY, Rasulov ko'chasi, A11",
    end_address:
...
const LoadHistoryDetails: React.FC<ActiveLoadsDetailProps> = ({
  navigation,
  route,
}) => {
  ...
  return (
    <View style={styles.container_all}>
      <View style={styles.header_con}>
        ...
        <IconFoundation
          onPress={() =>
            navigation.navigate("ActiveLoadDetailMap", {
              itemId: itemId,
              data: locations,
            })
          }
...
export default LoadHistoryDetails;
