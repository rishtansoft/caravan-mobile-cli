...
const NavigatorMap: React.FC<any> = ({ navigation }) => {
    ...
    const calculateRoute = async (start: Position) => {
        try {
            const response = await fetch(
                `https://api.mapbox.com/directions/v5/mapbox/driving/${start.longitude},${start.latitude};${DESTINATION.longitude},${DESTINATION.latitude}?geometries=geojson&overview=full&steps=true&access_token=pk.eyJ1IjoiaWJyb2hpbWpvbjI1IiwiYSI6ImNtMG8zYm83NzA0bDcybHIxOHlreXRyZnYifQ.7QYLNFuaTX9uaDfvV0054Q`
            );
