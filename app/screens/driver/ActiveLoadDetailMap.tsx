                ...
                <View style={styles.container}>
                    ...
                    <View>
                        <View style={{
                            ...
                            <MaterialIcons
                                name="circle" size={22} color="#0eb00e" />
                            <Text style={{ color: '#000', fontSize: 16 }}>Boshlang'ich nuqta</Text>
                        </View>
                        <View style={{
                            display: 'flex',
                            flexDirection: 'row',
                            ...
                            <MaterialIcons
                                name="circle" size={22} color="#b00e0e" />
                            <Text style={{ color: '#000', fontSize: 16 }}>Tugash nuqta</Text>
                        </View>
