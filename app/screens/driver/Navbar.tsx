...
const Navbar: React.FC<NavbarProps> = ({ activeTab, setActiveTab }) => {
    return (
        <View style={styles.container}>
            ...
            <TouchableOpacity
                style={styles.navItem}
                onPress={() => setActiveTab('contact_admin')}
            >
                <IconFontAwesome name="phone" size={24} color={(activeTab === 'contact_admin' || activeTab == 'contact_admin') ? '#5336E2' : '#898D8F'} />
                <Text style={[
                    styles.navText,
                    { color: (activeTab === 'contact_admin' || activeTab == 'contact_admin') ? '#5336E2' : '#898D8F' }
                ]}>
                    Admin
                </Text>
            </TouchableOpacity>
            ...
            >
                <IconFontAwesome name="user-circle-o" size={24} color={(activeTab === 'profile' || activeTab == 'profile_update' || activeTab == 'terms_condition') ? '#5336E2' : '#898D8F'} />
                <Text style={[
                    styles.navText,
                    { color: (activeTab === 'profile' || activeTab == 'profile_update' || activeTab == 'terms_condition') ? '#5336E2' : '#898D8F' }
                ]}>
                    Profil
                </Text>
            </TouchableOpacity>
