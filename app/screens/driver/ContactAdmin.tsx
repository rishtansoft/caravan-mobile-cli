...
const ContactAdmin = () => {
  ...
  const openTelegramLink = (telegramHandle) => {
      ...
      <View style={styles.contactBox}>
        ...
        <TouchableOpacity onPress={() => openTelegramLink("Mgoziyev")}>
          <View style={styles.contactItem}>
            ...
            <IconEntypo name="paper-plane" size={24} color="#7257FF" />
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => sendEmail("support@caravan.uz")}>
          <View style={styles.contactItem}>
            ...
            <IconMaterial name="email" size={24} color="#7257FF" />
          </View>
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={() => openWebsite("https://caravan.uz")}>
          <View style={styles.contactItem}>
            ...
            <IconEntypo name="globe" size={24} color="#7257FF" />
          </View>
        </TouchableOpacity>
      </View>
    </View>
