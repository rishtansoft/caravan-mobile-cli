        ...
        <View style={styles.container}>
            <View style={styles.buttonContainer}>
                <SelectionButton
                    ...
                    imageSource={require('../../../assets/img/dirver.png')} // Rasimni o'z loyihangizdan ko'rsating
                    title="Haydovchi"
                />
                ...
                <SelectionButton
                    ...
                    imageSource={require('../../../assets/img/cargo.png')} // Rasimni o'z loyihangizdan ko'rsating
                    title="Yuk egasi"
                />
            </View>
        </View>
